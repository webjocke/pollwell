export const wordCloudResultsPage = `
<!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
...
user-scalable=no">
      ...
      <body>
        <svg></svg>
        <h1 class="logo title"><span class="dark_blue">Poll</span><span class="blue">Well</span><span class="dark_blue smaller">.se</span></h1>
        <h1 id="pageTitle"></h1>
        ...
        <script>
          ...
          document.querySelector("h1#pageTitle").innerText = rawData.polls[rawData.activePoll].question;
